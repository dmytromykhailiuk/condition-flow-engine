...
export declare const subscribeOnAllDataAndContinueWhenConditionWillBeValid: <F>(condition: ConditionObject | LinkToCondition, context$: ObservableInput<F>, conditionsMap?: ConditionsMap) => <T>(source$: Observable<T>) => Observable<F>;
