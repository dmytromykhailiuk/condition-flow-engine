...
export interface EngineBackgroundControlBase {
    runEngineMethods: (EngineBackgroundControlForRunHook | EngineBackgroundControlForRunBackgroundFlows | EngineBackgroundControlForStopBackgrounFlows | EngineBackgroundControlForStopAllBackgrounFlows | EngineBackgroundControlForRunFlow)[];
}
